...
<p align="center">
  <img
    src="https://skillicons.dev/icons?i=nestjs,ts,dotnet,cs,postgres,docker,git,linux,c,cpp,py"
    alt="NestJS, TypeScript, .NET, C#, PostgreSQL, Docker, Git, Linux, C, C++ and Python"
  />
</p>
...
<img
  src="https://capsule-render.vercel.app/api?type=waving&color=0:B5FFFC,100:FFDEE9&height=120&section=footer"
  width="100%"
  alt="Footer"
/>
